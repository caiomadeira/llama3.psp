...
"""
Cria o tokenizer.bin com um formato customizado.
self.vocab: uma lista que guarda as strings de cada token (ex: "rei", "coroa").
self.vocab_scores: uma lista com as pontuações (score) de cada token, usadas no alg. de tokenização.
self.sorted_vocab: uma versão do vocabulário ordenada alfabeticamente pra otimizar as buscas.
"""
